...
public class InputMgr
{
    ...
    public void Connect_InputKeyController(Action<ENUM_INPUTKEY_NAME> _OnPointDownCallBack, Action<ENUM_INPUTKEY_NAME> _OnPointUpCallBack, Action<ENUM_INPUTKEY_NAME> _OnDragCallBack)
    {
        if (inputKeyManagement != null)
        {
        ...
        inputKeyController.Init(_OnPointDownCallBack, _OnPointUpCallBack, _OnDragCallBack);
